...
const previewText = {
  english:
    "Hello friends! I'm your MockMate AI interviewer. This is how I'll sound during your interview. Let's begin.",
  hindi:
    "नमस्कार दोस्तों! मैं आपका MockMate AI इंटरव्यूअर हूँ। इंटरव्यू के दौरान मेरी आवाज़ कुछ ऐसी होगी। चलिए शुरू करते हैं।",
  hinglish:
    "Namaskar dosto! I'm your MockMate AI interviewer. Interview ke dauran meri voice kuch aisi hogi. Let's begin!",
};
